# -*- coding: utf-8 -*-
"""
Created on Tue Jan 30 14:59:42 2024
...
import pandas as pd
import numpy as np
wbcd=pd.read_csv("C:/4-ML/Supervised Learning/Datasets/wbcd.csv")
wbcd.shape
...
#Similarly where ever there is M in the same culumn replace with 'Malignant'
...
#since in wbcd_n, we are already exclusing output column, hence all rows and columns
...
#let us assume you have 1000 data points, out of which 80 NC and 20 cancer
...
#Hence this model is not accepltable 
#for 5 same scenario
#for k=7 we are getting zero false positive and accuracy 
