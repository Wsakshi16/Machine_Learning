# -*- coding: utf-8 -*-
"""
Created on Wed Nov 22 16:06:24 2023
...
df=pd.read_csv('c:/0-datasets/myphonedata.csv')
df
...
df.head()
# It will show the first five rows of the data
df.shape
...
# so  we can say that the datapoints are scatter near the median
###############################################################################
df.info()
'''
...
# One outlier present
sns.boxplot(df)
# Here 3 columns(Green, Yellow, Orange) having 
